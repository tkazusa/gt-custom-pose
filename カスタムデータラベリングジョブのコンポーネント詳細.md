...
[{
    ...
    "consolidatedAnnotation": {
        "content": {
            "custom-labeling-psoe-20190728-clone-clone-clone": {
                "workerId": "private.us-east-1.7de59546cc74691a",
                "result": {
                    "annotatedResult": {
                ...
                "labeledContent": {
                    "s3Uri": "s3://gt-custom-labeling-pose/images/000033016.jpg"
                }
            }
        }
    }
...
SageMaker Ground Truthでラベリングジョブを実行すると、S3バケットへは下記のような構成で出力がされます。

```
output
|_custom-labeling-pose-20190728 
    |_annotation-tool
    |   |_template.liquid      
    |_annotations
...
ラベリングジョブの全ての工程が完了すると出力される`output.manifest`は下記の様なものです。

```output.manifest
{"source-ref":"s3://gt-custom-labeling-pose/images/000030973.jpg",
"custom-labeling-psoe-20190728-clone-clone-clone":{"workerId":"private.us-east-1.7de59546cc74691a","result":{"annotatedResult":{"inputImageProperties":{"height":720,"width":1280},"keypoints":[{"label":"頭","x":896,"y":439},{"label":"左肩","x":926,"y":479}]}},"labeledContent":{"s3Uri":"s3://gt-custom-labeling-pose/images/000030973.jpg"}},"custom-labeling-psoe-20190728-clone-clone-clone-metadata":{"type":"groundtruth/custom","job-name":"custom-labeling-psoe-20190728-clone-clone-clone","human-annotated":"yes","creation-date":"2019-07-27T13:28:27+0000"}}
```
